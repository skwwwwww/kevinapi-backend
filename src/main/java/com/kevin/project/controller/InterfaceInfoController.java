...
public class InterfaceInfoController {
    ...
    @Resource
    private KevinApiClient yuApiClient;
    ...
    public BaseResponse<Object> invokeInterfaceInfo(@RequestBody InterfaceInfoInvokeRequest interfaceInfoInvokeRequest,
        ...
        KevinApiClient tempClient = new KevinApiClient(accessKey, secretKey);
        Gson gson = new Gson();
        com.kevin.kevinapiclientsdk.model.User user = gson.fromJson(userRequestParams, com.kevin.kevinapiclientsdk.model.User.class);
